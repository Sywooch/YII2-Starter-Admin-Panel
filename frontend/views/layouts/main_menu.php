    ...
    <div class="top_nav_wrapper clearfix">
        <ul id="menu-main-menu" class="main_menu_nav">
            ...
            <li id="menu-item-1003"
                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1003">
                <a href="http://www.crewfacilities.com/solutions/">Solutions</a>
                <ul class="sub-menu">
                    <li id="menu-item-999"
                    ...
                    <li id="menu-item-1000"
                        ...
                        <a href="http://www.crewfacilities.com/employee-travel-policy/">Employee
                            Travel Policy</a></li>
            ...
            <li id="menu-item-1078"
                ...
                <a href="http://www.crewfacilities.com/about-us/">About Us</a>
                <ul class="sub-menu">
                    <li id="menu-item-1172"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1172">
                        <a href="http://www.crewfacilities.com/about-our-team/">About Our Team</a>
                    </li>
                </ul>
            </li>
            ...
            <li id="menu-item-1286" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1286"><a href="https://www.crewfacilities.com/room-request/">Room Request</a></li>
            <li id="menu-item-998"
            ...
            <li id="menu-item-1002" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-989  menu-item-1002">
                <a href="<?= Yii::$app->urlManager->createAbsoluteUrl('site/login')?>" data-method="post">Client Login</a>
            </li>
            <?php }else{?>
                <li id="menu-item-1002" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-175 current_page_item menu-item-997">

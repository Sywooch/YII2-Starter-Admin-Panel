...
$this->title = 'Booked & Confirm';
$this->params['breadcrumbs'][] = $this->title;

?>
<?php
$data = Yii::$app->session->get('confirmation_data');
    ?>
    <div class="container">
                    ...
                    <div class="item col-md-8 col-md-offset-2 grid-item" data-masonry='{ "itemSelector": ".grid-item"}'>
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <ul class="list-inline mrg-0 btm-mrg-10 clr-535353">
                                    <li><strong>Itinerary Id</strong> : <?php echo $data['HotelRoomReservationResponse']['itineraryId'] ?></li>

                                    <li style="list-style: none">|</li>

                                    <li><strong>Confirmation No</strong> : <?php echo isset($data['HotelRoomReservationResponse']['confirmationNumbers'])?(is_array($data['HotelRoomReservationResponse']['confirmationNumbers']))?implode(',',$data['HotelRoomReservationResponse']['confirmationNumbers']):$data['HotelRoomReservationResponse']['confirmationNumbers']:'n/a'?></li>

                                    <li style="list-style: none">

                                    <li><strong>Status</strong> : <?= \common\models\ExpediaIternary::getStatusName($data['HotelRoomReservationResponse']['reservationStatusCode'])?></li>
       ...
       *The credit card provided will be charged immediately for the full amount of the reservation
                    ...
                    <div class="item col-md-8 col-md-offset-2">
                        <span class="lead"><a class="btn btn-lg btn-block btn-warning" href="<?= Yii::$app->urlManager->createAbsoluteUrl(['requests/index']);?>" data-method="post"> My Requests</a></span>
                    </div>
                </div>
            </div>
        </div>

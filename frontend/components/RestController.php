...
class RestController extends Controller {
    ...
    public $expedia_cid = CID;
    public $expedia_api_key = API_KEY;
    public $expedia_secret_key = SECRET_KEY;
    public $ean_base_url = 'http://api.ean.com/ean-services/rs/hotel/v3/';
    public $ean_secured_base_url = 'https://book.api.ean.com/ean-services/rs/hotel/v3/';

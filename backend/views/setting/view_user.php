                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="controls controls-header pull-right">
                                    <a class="btn btn-primary edit-account" href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('user/edit-profile')?>"><i class="fa fa-edit"></i> Edit account</a>
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        First name </label>
                                    <div class="col-sm-9">
                                        <p class="form-control-static"><?= $model->profile->first_name ?></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        Last name </label>
                                    <div class="col-sm-9">
                                        <p class="form-control-static"><?= $model->profile->last_name ?></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">

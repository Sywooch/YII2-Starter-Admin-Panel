        ...
        <div class="">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="pull-left">
                        <a class="btn btn-app" href="<?= \yii\helpers\Url::toRoute('setting/add-controller') ?>">
                            <i class="fa fa-ellipsis-v"></i> Add Controller
                        </a>
                    </div>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'urlCreator' => function ($action, $model, $key, $index) {
                                    ...
                                    if ($action === 'update') {
                                        return \yii\helpers\Url::to(['setting/edit-controller/'.$key]);
                                    }
                                    if($action === 'delete'){
                                        return \yii\helpers\Url::to(['setting/delete-controller/'.$key]);
                                    }
                                }
                            ],
                        ],

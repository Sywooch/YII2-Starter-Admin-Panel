...
(function (e) {
    ...
    var x = window.MutationObserver || window.WebKitMutationObserver || !1, J = {
        ...
        if (G)return G;
        var e = document.createElement("DIV"), c = e.style, h = navigator.userAgent, n = navigator.platform, d = {haspointerlock: "pointerLockElement"in document || "webkitPointerLockElement"in document || "mozPointerLockElement"in document};
        ...
        a.opt.usetransition && a.opt.smoothscroll ? (this.prepareTransition = function (b, c) {
            ...
            function (b, c, d) {
                ...
                a.timer = setTimeout(function () {
                    var d = a.getScrollTop(), e = a.getScrollLeft(), h = Math.round(Math.sqrt(Math.pow(b - e, 2) + Math.pow(c - d, 2))), h = a.newscrollspeed &&

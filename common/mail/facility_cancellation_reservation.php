                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="mcnTextContent"
                                                    ...
                                                    <p>Front Desk,<br>
                                                        <br>We are cancelling the reservation under CrewFacilities.com, Hotel Confirmation # <?= $confirmation_no;?>
                                                        <br>CrewFacilities Reservation # <?= $reservation_no; ?>
                                                        <br>
                                                     <br>

                                                    <span style="font-size:18px">Please reply to this email with cancellation confirmation.</span></p>
                                                    <ul>
                                                        <li style="font-size:13px; color:grey;">Please do not give the folio or final bill to the guest or place folio in their room.  Email to Billing@CrewFacilities.com or fax to 1-866-719-9092. </li>
                                                    </ul>

                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="mcnTextContent"
                                                    style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                        ...
                                                        <br>Your reservation has been CANCELLED. Please review ALL DETAILS to verify accuracy and reply "approved" in order for us to finalize your reservation.
                                                        <br>
                                                    <?php if($assinged){?>
                                                        <br>Hotel Cancellation Confirmation # <?= $cancellation_no; ?>
                                                    ...
                                                    <?php } ?>
                                                    <br><br><br>
                                                    # of Single Room Cancelled : <?=$single_rooms;?>
                                                    <br># of Double Room Cancelled : <?=$double_rooms;?>

                                                    <br>Original Check in date : <?=$check_in_date;?>
                                                    <br>Original Check out date : <?=$check_out_date;?>

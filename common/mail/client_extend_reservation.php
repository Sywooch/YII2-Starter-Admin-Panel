                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="mcnTextContent"
                                                    style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                        ...
                                                        <br>Your reservation has been CHANGED. Please reply "approved" in order for us to finalize your reservation.
                                                        <br>

                                                        <br>Hotel CHANGE Confirmation #: <?= $confirmation_no; ?>

                                                        <br>
                                                        <br> <?= $facility_name;?>
                                                        <br> <?= $facility_address;?>
                                                        <br> <?= $facility_city;?> <?= $facility_state;?><?= $facility_zip;?>
                                                        <br> <?= $facility_phone;?>

                                                    <br><br><br>
                                                    # of Single Room Changed : <?=$single_rooms;?>
                                                    <br># of Double Room Changed : <?=$double_rooms;?>

                                                    <br>Original Check in date : <?=$old_check_in_date;?>
                                                    <br>Original Check out date : <?=$old_check_out_date;?>

                                                    <br>New Check in date : <?=$check_in_date;?>
                                                    <br>New Check out date : <?=$check_out_date;?>

                                                    <br>
                                                    <br>
                                                    Crew Names: <?= $guest_name;?>
                                                    <br>
                                                    <br>
                                                    <br>Job #: <?=$job_no?>
                                                    <br>PO #: <?=$job_no?>
                                                    <br>Region to be billed: <?=$client_name?>
